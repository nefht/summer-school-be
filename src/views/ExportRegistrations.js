...
const ExportRegistrations = () => {
  ...
  const exportToExcel = () => {
    const headers = [
      ...
      { label: 'Trạng thái đăng ký', key: 'status' },
    ];
    ...
    worksheetData.unshift(['DANH SÁCH ĐĂNG KÝ HỌC HÈ']);
    ...
    const titleRange = XLSX.utils.decode_range('A1:J1');
    ...
    const headerRange = XLSX.utils.decode_range('A2:J2');
    ...
    saveAs(blob, 'DanhSachDangKyHocHe.xlsx');
  };
